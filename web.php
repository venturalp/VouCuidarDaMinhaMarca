...
isso já é um motivo mais que suficiente para sua empresa ter um site institucional.</h2>
    <section class="sec-web1">
        <article class="art-web-1">
            <h1 class="white">O QUE É UM SITE <span>institucional?</span></h1>
            <p class="white">É o cartão de visitas da empresa no mundo virtual e a porta de entrada para bons negócios.</p>
            <img class="web-globo" src="images/Globe-Internet.png" />
        </article>
        <div class="faixa-web"></div>
        <article class="art-web-2">
            <h2>Cinco motivos pra você
entrar para o meio virtual</h2>
            <div class="web-motivos">
                <div class="web-motivo">
                    <img src="images/icone_credibilidade.png" />
                    <h1>CREDIBILIDADE</h1>
                    <p>Todo usuário espera que uma companhia séria e atualizada tenha um espaço virtual. Essa atitude demonstra comprometimento e profissionalismo. </p>
                </div>
                <div class="web-motivo">
                    <img src="images/icone_informacao.png" />
                    <h1>INFORMAÇÕES BÁSICAS</h1>
                    <p>Usamos a internet para buscar informações sobre diversos assuntos, inclusive informações sobre empresas. Para fazer contato, sugestões, reclamações e até adquirir produtos. Fica disponível o tempo todo e ainda alcança consumidores no mundo inteiro.</p>
                </div>
                <div class="web-motivo">
                    <img src="images/icone_baixo.png" />
                    <h1>BAIXO CUSTO</h1>
                    <p>O custo para se manter um site no ar é baixo.. Para o seu desenvolvimento, os valores podem variar bastante, dependendo da funcionalidade e interface, mas ainda assim, é mais em conta do que muitos outros meios de divulgação de marca.</p>
                </div>
                <div class="web-motivo">
                    <img src="images/icone_clientes.png" />
                    <h1>CONTATO COM CLIENTES</h1>
                    <p>Com algumas ferramentas disponíveis, a sua empresa pode ter acesso a algumas informações dos visitantes do site, conhecendo-os de maneira útil para que possam ser aplicadas estratégias, que estejam de acordo com o perfil do seu público-alvo.</p>
                </div>
                <div class="web-motivo">
        ...
        <article class="art-web-3">
            <div class="web-naoespere">
